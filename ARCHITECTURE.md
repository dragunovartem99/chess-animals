...
| `talk`         | what the animals say: the Stockfish observer and its verdicts from White's view, the win chance, the eval swings worth a remark, who answers one with what, and the seeded pick of what is said |
