...
// paper rates it the best of its simple strategies; here it is the least of the animals that
// have an idea, because the ones it is up against read a whole position and it reads one move.
//
