...
// and a quarter here. The paper's version has no material sense at all; the `material` base
// keeps the coils from being wound out of pieces it no longer has.
