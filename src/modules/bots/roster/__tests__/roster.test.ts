...
// that don't, and the test holds them to that. The Mouse joins them on purpose: it plays at random
// among its most cramped moves, so it losing to random play is the placement, not a bug. The Dodo
