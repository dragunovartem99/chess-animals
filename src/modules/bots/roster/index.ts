...
// the Sloth pulls it all home, the Elephant keeps to its own colour, the Parrot mirrors the board,
// the Spider gives every piece the most squares it can reach — at depth 1, a ply short of the rest,
// which is what drops it below the Parrot — the Goat chases checks and captures, the Dove refuses
...
// `space`, with a little `castled`) and the Hare (`offeredMaterial` + `hanging`) on pairs the lab
