...
engine/
  ...
  src/eval/    lazy attack-map context, one function per feature, terminal score, dot product
...
- `engine/bench` over a fixed position set prints perft Mnps, ns per feature and search
