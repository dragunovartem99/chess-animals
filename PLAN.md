...
| Commit                                             | Contents                                                                                                                                                                                                                                                                                                   | Green when                                                                                                                   |
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| ⬜ `engine: add iterative deepening and the tt`    | ID to the bot's depth, TT-move ordering, `nodeLimit` returns the last iteration. The limit is also what bounds quiescence: on a bot blind to material (the Dodo's weights) or reading both seats alike (the Parrot's), stand-pat and delta pruning never cut, and one depth-1 move costs millions of nodes | Same move and score as fixed depth without the TT; fewer nodes; a material-blind bot with quiescence stays within its budget |
