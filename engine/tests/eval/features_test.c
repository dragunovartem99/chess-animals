...
static const int PORTED[] = {
    FEATURE_MATERIAL_PAWN,  FEATURE_MATERIAL_KNIGHT, FEATURE_MATERIAL_BISHOP, FEATURE_MATERIAL_ROOK,
    FEATURE_MATERIAL_QUEEN, FEATURE_CENTRALIZATION,  FEATURE_DEVELOPMENT,     FEATURE_EARLY_QUEEN,
    FEATURE_CASTLED,        FEATURE_KING_DANGER,     FEATURE_MOBILITY};
